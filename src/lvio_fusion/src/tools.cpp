...
bool imu::InertialOptimization(Frames &key_frames, Eigen::Matrix3d &Rwg, double priorG, double priorA, bool isOptRwg)
{
...
void imu::RecoverData(Frames active_kfs, SE3d old_pose, bool bias)
{
