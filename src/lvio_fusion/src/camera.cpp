...
// Vector3d Camera::World2Sensor(const Vector3d &p_w, const SE3d &T_c_w)
// {
//     return extrinsic * T_c_w * p_w;
// }

// Vector3d Camera::Sensor2World(const Vector3d &p_c, const SE3d &T_c_w)
// {
//     return T_c_w.inverse() * extrinsic.inverse() * p_c;
// }

// Vector2d Camera::Sensor2Pixel(const Vector3d &p_c)
// {
//     return Vector2d(
...
// Vector3d Camera::Pixel2Sensor(const Vector2d &p_p, double depth)
// {
//     return Vector3d(
//         (p_p(0, 0) - cx) * depth / fx,
//         (p_p(1, 0) - cy) * depth / fy,
