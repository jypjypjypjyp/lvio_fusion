...
public:
    ...
    LidarPlaneError(Vector3d p, Vector3d pa, Vector3d pb, Vector3d pc, Vector3d last_kf_t, Vector3d kf_t, Lidar::Ptr lidar)
    ...
    {
        return (new ceres::AutoDiffCostFunction<LidarPlaneError, 1, 4, 4>(new LidarPlaneError(p, pa, pb, pc, last_kf_t, kf_t, lidar)));
    }
